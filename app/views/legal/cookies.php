<main class="fp-fade" style="max-width:720px;margin:0 auto;padding:120px 24px 96px;">
    ...
    <div style="color:#d1d5db;font-size:15px;line-height:1.75;">
        ...
        <h2 style="font-size:20px;font-weight:700;color:#fff;margin:32px 0 12px;">1. ¿Qué son las cookies?</h2>
        ...
        <h2 style="font-size:20px;font-weight:700;color:#fff;margin:32px 0 12px;">2. Cookies que utilizamos</h2>
        <table style="width:100%;border-collapse:collapse;margin:16px 0;">
            <thead>
                <tr style="border-bottom:1px solid rgba(255,255,255,.1);text-align:left;color:#fff;">
        ...
        <h2 style="font-size:20px;font-weight:700;color:#fff;margin:32px 0 12px;">3. Cookies de terceros</h2>
